"""
Django settings for Veneskoski project.
...
SECRET_KEY = '=dalosjn7$*i+=_+ehfxke=cfr4z@citn*kjhf+46@ge)gefrg'
...
WSGI_APPLICATION = 'Veneskoski.wsgi.application'
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    'theme_advanced_buttons2': 'justifyleft, justifycenter, justifyright, justifyfull, separator, indent, outdent, separator, visualblock',
    'theme_advanced_buttons3': 'undo, redo, separator, cut, copy, paste, preview',
    'width': '1252',
    'height': 1024,
    'content_css': '../../css/style.css',
    'body_class': 'tinymce_div',
    'relative_urls': False,
